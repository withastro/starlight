...
/**
 * This matches the shape of a collection entry data frontmatter object minus the following
 * properties:
 *
...
export type VirtualRoute = BaseRoute &
	Omit<LocaleData, 'locale'> &
	Omit<StarlightDocsEntry['data'], 'editUrl' | 'sidebar'>;
