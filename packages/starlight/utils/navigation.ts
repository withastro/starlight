...
function makeSidebarLink(opts: MakeLinkOptions & { autogenerated?: false }): SidebarManualLink;
function makeSidebarLink(opts: MakeLinkOptions & { autogenerated: true }): SidebarAutoLink;
function makeSidebarLink({ attrs, badge, href, label, autogenerated }: MakeLinkOptions) {
	if (!isAbsoluteUrl(href)) {
		href = formatPath(href);
	}
	return makeLink({ label, href, badge, attrs, autogenerated });
}
