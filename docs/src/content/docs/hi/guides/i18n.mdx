...
यदि आपको प्रत्येक स्थान के लिए शीर्षक को अनुकूलित करने की आवश्यकता है, तो आप Starlight के विकल्पों में [`title`](/reference/configuration/#title-required) के लिए एक ऑब्जेक्ट पास कर सकते हैं:
