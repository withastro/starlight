	...
	config={[
		{
			label: 'guides',
			items: [
				{ label: 'अवयवों', link: '/guides/components/' },
				{ label: 'अंतर्राष्ट्रीयकरण (i18n)', link: '/guides/i18n/' },
			],
		},
		{
			label: 'reference',
			items: [
				{ label: 'कॉन्फ़िगरेशन संदर्भ', link: '/reference/configuration/' },
			],
		},
	]}
/>
...
starlight({
	sidebar: [
		...
		{ label: 'CSS और स्टाइलिंग', link: '/guides/css-and-tailwind/' },
...
डिफ़ॉल्ट रूप से पेजों को फ़ाइल नाम के अनुसार वर्णानुक्रम में क्रमबद्ध किया जाएगा।
	...
	config={[
		{
			...
			items: [
				...
				{ label: 'अंतर्राष्ट्रीयकरण (i18n)', link: '/guides/i18n/' },
				{
					label: 'advanced',
					items: [
						{ label: 'परियोजना संरचना', link: '/guides/project-structure/' },
					],
				},
			],
		},
...
starlight({
	sidebar: [
		...
		// "Deprecated" बैज वाला एक स्वतः निर्मित समूह।
		{
			label: 'संदर्भ',
			badge: 'Deprecated',
...
`text` प्रदर्शित की जाने वाली कंटेंट का प्रतिनिधित्व करता है (उदाहरण के लिए "New")।
	...
	sidebar: [
		{
			label: 'मार्गदर्शिका',
			items: [
				// पीले "Experimental" बैज वाला एक लिंक।
				{
					label: 'अवयवों',
					link: '/guides/components/',
