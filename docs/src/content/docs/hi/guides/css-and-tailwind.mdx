...
- Tailwind `डार्क` कॉन्फ़िगर करना: Starlight के डार्क मोड के साथ काम करने के लिए वेरिएंट।
- Starlight के UI में Tailwind [थीम रंगों और फॉण्ट](#tailwind-के-साथ-starlight-को-स्टाइल-करें) का उपयोग करता है।
- Tailwind बॉर्डर उपयोगिता वर्गों के लिए आवश्यक प्रीफ़्लाइट के आवश्यक भागों को चुनिंदा रूप से पुनर्स्थापित करते समय Tailwind [प्रीफ़्लाइट](https://tailwindcss.com/docs/preflight) रीसेट शैलियों को अक्षम करें।
...
>
	<Fragment slot="css-docs">
		इस थीम को अपनी साइट पर लागू करने के लिए एक [कस्टम सीएसएस
