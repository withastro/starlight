...
<Tabs>
	<TabItem label="Stars">Sirius, Vega, Betelgeuse</TabItem> //TODO
...
एक `<Card>` के लिए एक `title` की आवश्यकता होती है और इसमें वैकल्पिक रूप से [Starlight के अंतर्निहित आइकनों में से एक](#all-icons) के नाम पर सेट एक `icon` विशेषता शामिल हो सकती है।
...
<Card title="इसको देखेF">दिलचस्प कंटेंट जिसे आप हाइलाइट करना चाहते हैं।</Card>
...
`<LinkCard>` के लिए एक शीर्षक और एक [`href`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#href) विशेषता की आवश्यकता होती है। आप वैकल्पिक रूप से एक संक्षिप्त `description` या `target` जैसी अन्य लिंक विशेषताएँ शामिल कर सकते हैं।
...
<CardGrid>
	<LinkCard title="Markdown का संलेखन" href="/guides/authoring-content/" />
	<LinkCard title="अवयवों" href="/guides/components/" />
</CardGrid>
```
...
प्रत्येक `<Icon>` को एक [`name`](#all-icons) की आवश्यकता होती है और इसमें वैकल्पिक रूप से एक `label`, `size`, और `color` विशेषता शामिल हो सकती है।
