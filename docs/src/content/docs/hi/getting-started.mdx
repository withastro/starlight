...
मौजूदा Astro परियोजना में Starlight जोड़ने के लिए [मैन्युअल सेटअप निर्देश](/manual-setup/) देखें।
...
स्थानीय स्तर पर काम करते समय, [Astro का विकास सर्वर](https://docs.astro.build/en/reference/cli-reference/#astro-dev) आपको अपने काम का पूर्वावलोकन करने देता है और जब आप परिवर्तन करते हैं तो स्वचालित रूप से आपके ब्राउज़र को रीफ्रेश करता है।
...
आप प्रायोगिक [Astro Markdoc एकीकरण](https://docs.astro.build/en/guides/integrations-guide/markdoc/) स्थापित करके Markdoc के लिए समर्थन जोड़ सकते हैं।
...
- **डिप्लॉय:** Astro Docs में ["अपनी साइट परिनियोजित करें"](https://docs.astro.build/en/guides/deploy/) मार्गदर्शिका के साथ अपना कार्य प्रकाशित करें।
...
Starlight एक Astro एकीकरण है, और इसे किसी भी `@astrojs/*` एकीकरण की तरह अद्यतन किया जाता है:
...
यह सुनिश्चित करने के लिए कि आपकी Starlight साइट कॉन्फ़िगर है और ठीक से काम कर रही है, [परियोजना कॉन्फ़िगरेशन](/reference/configuration/) और [व्यक्तिगत पेज फ्रंटमैटर कॉन्फ़िगरेशन](/reference/frontmatter/) संदर्भ पेजो का उपयोग करें।
सामग्री जोड़ने और अपनी स्टारलाइट साइट को अनुकूलित करने में सहायता के लिए साइडबार में मार्गदर्शिकाएँ देखें।

यदि आपका उत्तर इन दस्तावेज़ों में नहीं मिल सकता है, तो संपूर्ण Astro दस्तावेज़ीकरण के लिए कृपया [Astro दस्तावेज़](https://docs.astro.build) देखें।
