...
The official [Algolia DocSearch](https://docsearch.algolia.com/) plugin can be used to replace Pagefind, the default search provider, with Algolia DocSearch.

To learn more about the Algolia DocSearch plugin, see the [plugin installation instructions](/guides/site-search/#algolia-docsearch).

### Community plugins

These community plugins can be used to customize your Starlight site.
