...
通过用代码反引号包裹文件名，可以转义文件名中的特殊字符，例如下划线或空格。
...
**实现：** [`FileTree.astro`](https://github.com/withastro/starlight/blob/main/packages/starlight/src/user-components/FileTree.astro)
