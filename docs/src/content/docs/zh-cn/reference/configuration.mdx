...
页面可以使用 [`prev`](/zh-cn/reference/frontmatter/#prev) 和 [`next`](/zh-cn/reference/frontmatter/#next) frontmatter 字段覆盖此设置或链接文本 **和/或** URL。
...
访问 [插件 showcase](/zh-cn/resources/plugins/) 查看可用插件列表。
