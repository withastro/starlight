...
举个例子，该项目将 `src/content/docs/` 中的 Markdown 内容与 `src/pages/` 中的 Astro 和 HTML 路由混合在一起：
...
<StarlightPage frontmatter={{ title: '我的自定义页面' }}>
	...
	<AnchorHeading level="2" id="learn-more">
		了解更多
	</AnchorHeading>
	<p>
	...
	sidebar={[
		{ label: '首页', link: '/' },
		{
			...
			items: [
				...
				{ label: '小熊座', link: '/ursa-minor/', badge: 'Stub' },
			],
		},
	]}
>
...
<AnchorHeading level="2" id="sub-heading">
	子标题
</AnchorHeading>
```
