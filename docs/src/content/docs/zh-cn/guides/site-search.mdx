...
1. 创建一个 TypeScript 文件，导出你的 DocSearch 配置。
...
[社区插件](/zh-cn/resources/plugins/#社区插件) 也可以提供 Starlight 内置 Pagefind 搜索的替代方案。

#### Typesense DocSearchs

[Starlight DocSearch Typesense](https://starlight-docsearch.typesense.org/) 社区插件提供了一个开源且可自托管的替代方案，它将 [DocSearch](https://github.com/typesense/typesense-docsearch.js) 界面与 [Typesense](https://typesense.org/) 后端集成在一起。

请参阅 Starlight DocSearch Typesense 文档中的 [“快速开始”](https://starlight-docsearch.typesense.org/getting-started/) 指南，了解如何在你的项目中使用它。
