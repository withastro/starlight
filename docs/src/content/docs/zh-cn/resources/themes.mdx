...
<ThemeGrid
	...
	themes={[
		...
		},
		{
			...
			description: '一个直观、现代的 Starlight 主题，带有流畅的出现动画。',
		...
		},
		{
			...
			description: '一个结合现代与复古元素的自定义 Astro Starlight 主题。',
		...
		},
		{
			...
			description: '一个简洁现代的主题，拥有无缝侧边栏和温暖的点缀色。',
		...
		},
		{
			...
			description: '一个锐利、精致的产品文档主题，灵感来源于 shadcn/ui。',
		...
		},
		{
			title: 'Starlight MD3',
			description:
				'一个受 Material Design 3 和 Material You 启发的主题，具有动态颜色角色、色调表面、状态层和动效。',
