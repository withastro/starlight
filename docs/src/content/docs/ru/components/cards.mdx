...
### Добавление иконок в карточках

Включите иконку в карточку, используя атрибут [`icon`](#icon), установленный на имя [одной из встроенных иконок Starlight](/ru/reference/icons/#все-иконки).
