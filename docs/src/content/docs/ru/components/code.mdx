...
Используйте [суффикс `?raw`](https://vitejs.dev/guide/assets#importing-asset-as-string) в MDX-файлах и компонентах Astro, чтобы импортировать любой файл кода в виде строки.
