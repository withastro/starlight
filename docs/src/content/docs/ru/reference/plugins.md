...
Чтобы использовать добавленные переводы в интерфейсе вашего плагина, следуйте [руководству по использованию UI-переводов](/guides/i18n/#использование-ui-переводов).
