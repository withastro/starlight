...
Перейдите на новый API Content Layer, используя [`docsLoader` Starlight](/ru/manual-setup/#configure-content-collections), и используйте свойство [`id`](#id) вместо этого.
