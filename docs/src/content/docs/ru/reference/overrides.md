...
Объект, содержащий строки пользовательского интерфейса, локализованные для текущей страницы. Список всех доступных ключей см. в разделе [Перевод UI Starlight](/ru/guides/i18n/#перевод-ui-starlight).
