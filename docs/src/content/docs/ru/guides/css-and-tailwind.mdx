...
Любой пользовательский CSS без слоёв будет переопределять стили по умолчанию из слоя `starlight`.

Если вы используете каскадные слои, вы можете использовать [`@layer`](https://developer.mozilla.org/ru/docs/Web/CSS/@layer) в вашем пользовательском CSS для определения порядка приоритета различных слоёв относительно стилей Starlight:
...
>
	...
	<Fragment slot="tailwind-docs">
		...
		CSS](#стилизация-starlight-с-использованием-tailwind), чтобы применить эту тему к вашему сайту.
	</Fragment>
</ThemeDesigner>
