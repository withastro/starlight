...
В настоящее время поддерживаются ссылки на Bitbucket, Codeberg, CodePen, Discord, Email, Facebook, GitHub, GitLab, Gitter, Instagram, LinkedIn, Mastodon, Microsoft Teams, Patreon, Reddit, RSS-ленту, Stack Overflow, Telegram, Threads, Twitch, Twitter, X и Youtube.
