...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			title="Собираем отзывы пользователей с помощью Encatch"
			description="Добавьте в документацию Starlight отзывы читателей, предложения по улучшению и сбор сообщений о проблемах прямо на страницах."
		/>
	</CardGrid>
</ThirdPartyContent>
