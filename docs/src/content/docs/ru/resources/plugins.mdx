...
<CardGrid>
	...
	<LinkCard
		...
		description="Добавляет функционал полноэкранного режима для блоков кода Expressive Code в вашей документации."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starlight-auto-drafts"
		title="starlight-auto-drafts"
		description="Изменяет поведение черновиков по умолчанию и автоматически убирает ссылки на черновики в боковой панели в продакшене."
	/>
</CardGrid>
...
<CardGrid>
	...
	<LinkCard
		...
		title="astro-d2"
		description="Преобразует блоки кода D2 Markdown в диаграммы."
	/>
</CardGrid>
