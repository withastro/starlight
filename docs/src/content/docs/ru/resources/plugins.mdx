...
<CardGrid>
	...
	/>
	<LinkCard
		href="https://github.com/lorenzolewis/starlight-multi-sidebar"
		title="starlight-multi-sidebar"
		description="Добавление нескольких боковых панелей на вашем сайте Starlight."
	/>
	<LinkCard
		href="https://github.com/trueberryless/starlight-view-modes"
		title="starlight-view-modes"
		description="Добавление различных режимов просмотра на сайт Starlight."
	/>
</CardGrid>
