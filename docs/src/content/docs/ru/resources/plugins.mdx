...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			description="Набор компонентов документации в стиле Swagger, который отображает документацию по классам, методам, свойствам и типам с подсветкой синтаксиса с учётом темы — всё в лёгком DOM."
		/>
		<LinkCard
			href="https://github.com/andriygm/starlight-base-path/"
			title="starlight-base-path"
			description="Автоматически добавляет ваш настроенный базовый путь к ссылкам в контенте."
		/>
		<LinkCard
			href="https://github.com/trueberryless-org/starlight-recipes/"
			title="starlight-recipes"
			description="Плагин Starlight для создания сайта с рецептами."
		/>
		<LinkCard
			href="https://github.com/max-ostapenko/starlight-md-txt"
			title="starlight-md-txt"
			description="Предоставьте страницы документации Starlight в виде необработанного Markdown, удобного для обработки ИИ-агентами, по URL-адресам с суффиксом `.md.txt`."
		/>
		<LinkCard
			href="https://github.com/TechDocsStudio/starlight-biel"
			title="starlight-biel"
			description="Добавьте чат-бота Ask AI, который отвечает на вопросы на основе вашего контента с помощью Biel.ai."
		/>
		<LinkCard
			href="https://github.com/babblebey/starlight-page-context-action"
			title="starlight-page-context-action"
			description="Сделайте полезные действия, такие как копирование/просмотр страницы в формате Markdown, открытие в ИИ-чате и переход наверх страницы, всегда доступными в вашей документации."
		/>
		<LinkCard
			href="https://github.com/AshutoshRaj97/agentready-mcp/tree/main/starlight-plugin"
			title="starlight-agentready"
			description="Отправляйте документацию в AgentReady после каждой сборки, чтобы ИИ-агенты могли получать к ней доступ через MCP."
		/>
		<LinkCard
			href="https://github.com/ewels/starlight-pydocs"
			title="starlight-pydocs"
			description="Автоматическая документация Python API для Astro и Starlight с использованием статического анализа."
		/>
		<LinkCard
			href="https://github.com/ewels/starlight-quiz"
			title="starlight-quiz"
			description="Интерактивные викторины для Astro и Starlight, созданные в Markdown с полным отслеживанием прогресса."
		/>
		<LinkCard
			href="https://frostybee.github.io/starlight-custom-navigation/"
			title="starlight-custom-navigation"
			description="Добавляет боковые панели навигации, плавающие кнопки, сочетания клавиш и жесты смахивания для перехода между страницами."
		/>
	</CardGrid>
</ThirdPartyContent>
...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			description="Локальный браузерный редактор для редактирования страниц Markdown и MDX, управления метаданными и предварительного просмотра документации Starlight без необходимости работать с исходными файлами."
		/>
	</CardGrid>
</ThirdPartyContent>
