...
<ThemeGrid
	...
	themes={[
		...
		},
		{
			...
			description:
				'Арктическая, северно-голубая тема для Starlight, вдохновленная темой Nord от Arctic Ice Studio',
		...
		},
		{
			...
			description:
				'Кастомизированная тема Astro Starlight, сочетающая современные и ретро-элементы.',
		...
		},
		{
			...
			description:
				'Чистая, современная тема с бесшовными боковыми панелями и тёплыми акцентами.',
		...
		},
		{
			...
			description:
				'Стильная, отполированная тема для документации продуктов, вдохновлённая shadcn/ui.',
		...
		},
		{
			title: 'Starlight MD3',
			description:
				'Тема, вдохновлённая Material Design 3 и Material You, с динамическими цветовыми ролями, тональными поверхностями, слоями состояний и анимацией.',
		...
		},
		{
			...
			description:
				'Тема, которая воссоздаёт внешний вид и ощущения от mdBook проекта rust-lang, включая его макет, элементы интерфейса и пять встроенных цветовых схем.',
		...
		},
		{
			title: 'Exquisitus',
			description:
				'Тема Starlight, которая сочетает удобство чтения и красоту, не жертвуя ни одним из этих качеств.',
