...
как показано во [введении](/ru/getting-started/#creating-a-new-project).
...
Starlight является [интеграцией Astro](https://docs.astro.build/en/guides/integrations-guide/).
...
Starlight создан на основе [коллекций контента](https://docs.astro.build/en/guides/content-collections/) Astro,
...
На данный момент Starlight не поддерживает [развертывание с SSR](https://docs.astro.build/en/guides/server-side-rendering/)
