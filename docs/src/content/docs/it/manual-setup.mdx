...
Il modo più rapido per creare un nuovo sito Starlight è utilizzare `create astro` come mostrato nella [guida introduttiva](/getting-started/#creating-a-new-project).
...
Starlight è un'[integrazione Astro](https://docs.astro.build/en/guides/integrations-guide/). Aggiungilo al tuo sito eseguendo il comando `astro add` nella directory principale del tuo progetto:
...
Trova tutte le opzioni disponibili nel [riferimento per la configurazione di Starlight](/reference/configuration/).

### Configura raccolte di contenuti

Starlight si basa sulle [raccolte di contenuti](https://docs.astro.build/en/guides/content-collections/) di Astro, che sono configurate nel file `src/content/config.ts`.
...
Vedi tutte le opzioni disponibili nel [riferimento frontmatter](/reference/frontmatter/).
