...
<CardGrid stagger>
	<Card title="Documentazione che delizia" icon="open-book">
		Include: Navigazione, ricerca, internazionalizzazione, SEO, caratteri
		facili da leggere, evidenziazione del codice, tema scuro e altro.
	</Card>
...
<TestimonialGrid titolo="Cosa dicono le persone">
  <Testimonial
    name="Rachel"
    handle="rachelnabors"
