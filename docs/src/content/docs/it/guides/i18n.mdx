...
Se hai bisogno di personalizzare il titolo per ogni locale, puoi passare un oggetto a [`title`](/it/reference/configuration/#title-required) nelle opzioni di Starlight:
