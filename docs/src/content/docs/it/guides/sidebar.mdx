...
I [collegamenti interni](#collegamenti) utilizzeranno automaticamente i titoli delle pagine tradotti dal frontmatter del contenuto per impostazione predefinita:
