...
- Utilizza Tailwind [colori e caratteri del tema](#swtyling-di-starlight-con-tailwind) nell'interfaccia utente di Starlight.
...
>
	<Fragment slot="css-docs">
		Aggiungi il seguente CSS al tuo progetto in un file [custom CSS
		file](#custom-css-styles) per applicare questo tema al tuo sito.
	</Fragment>
	<Fragment slot="tailwind-docs">
		L'esempio [file di configurazione di Tailwind](#styling-starlight-with-tailwind) di seguito
		include tavolozze di colori "accento" e "grigio" generate da utilizzare in
