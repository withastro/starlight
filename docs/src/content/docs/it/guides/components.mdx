...
<CardGrid>
	<LinkCard title="Creazione di contenuti in Markdown" href="/it/guides/authoring-content/" />
...
Specifica la struttura dei tuoi file e directory con una [lista Markdown non ordinata](https://www.markdownguide.org/basic-syzntax/#unordered-lists) all'interno di `<FileTree>`.
