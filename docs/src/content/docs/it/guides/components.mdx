...
[Vedi di più sulla costruzione di componenti nella documentazione Astro](https://docs.astro.build/fr/core-concepts/astro-components/).
...
Vedi di più su come [usare componenti in MDX](https://docs.astro.build/fr/guides/markdown-content/#using-components-in-mdx) nella documentazione Astro.
...
Aggiungi l'attributo `stagger` per rappresentare la seconda colonna più in basso per rendere il tutto più interessanti:
