...
<YouTubeGrid
	videos={[
		...
		},
		{
			...
			title: 'Template di Documentazione Astro Starlight (costruisci documentazione per app personalizzate!)',
			description: 'Metti in piedi un nuovo sito Starlight in circa 5 minuti',
		},
		{
			href: 'https://www.youtube.com/watch?v=12o7WxjAxjM',
			title: 'Includere documentazione Starlight in un progetto Next.js con proxy',
			description:
		...
		},
		{
			...
			title: "Ho Ricreato la Documentazione di Shadcn in 30 Minuti Con Questo Fantastico Strumento",
			description:
