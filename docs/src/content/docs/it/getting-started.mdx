...
Starlight supporta la creazione di contenuti in Markdown e MDX. (Puoi aggiungere il supporto per Markdoc installando l'integrazione sperimentale [Astro Markdoc](https://docs.astro.build/fr/guides/integrations-guide/markdoc/)).
...
[Impara come pubblicare un sito Astro nella documentazione](https://docs.astro.build/fr/guides/deploy/)
