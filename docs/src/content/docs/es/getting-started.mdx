...
Consulta las [instrucciones de configuración manual](/manual-setup/) para agregar Starlight a un proyecto de Astro existente.
...
Cuando trabajas localmente, el [servidor de desarrollo de Astro](https://docs.astro.build/en/reference/cli-reference/#astro-dev) te permite previsualizar tu trabajo y actualiza automáticamente tu navegador cuando realizas cambios.
...
- **Configura:** Aprende acerca de las opciones comunes en [“Personalizando Starlight”](/guías/personalización/).
- **Navega:** Configura tu barra lateral siguiendo la guía [“Barra Lateral de Navegación”](/guides/sidebar/).
- **Componentes:** Descubre tarjetas incorporadas, pestañas y más en la guía [“Componentes”](/guides/components/).
- **Despliega:** Publica tu trabajo siguiendo la guía [“Despliega tu sitio”](https://docs.astro.build/en/guides/deploy/) en la documentación de Astro.
...
Utiliza las páginas de referencia de [configuración del proyecto](/reference/configuration/) y [configuración del frontmatter de páginas individuales](/reference/frontmatter/) para asegurarte de que tu sitio de Starlight esté configurado y funcione correctamente. 
...
Si no encuentras la respuesta en la documentación, visita la [documentación completa de Astro](https://docs.astro.build) para obtener la documentación completa de Astro.
