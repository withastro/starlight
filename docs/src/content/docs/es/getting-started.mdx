...
Esto creará un nuevo [directorio de proyecto](/guides/project-structure/) con todos los archivos y configuraciones necesarios para tu sitio.
...
Starlight admite la creación de contenido en Markdown y MDX. (Puedes agregar compatibilidad con Markdoc instalando la integración experimental de [Astro Markdoc](https://docs.astro.build/en/guides/integrations-guide/markdoc/).)
...
### Frontmatter con tipos de datos seguros
