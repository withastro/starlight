...
También puedes obtener ayuda en el [Discord de Astro](https://astro.build/chat/) de nuestra activa y amigable comunidad. ¡Puedes publicar preguntas en nuestro foro `#support` o visitar nuestro canal dedicado `#starlight` para discutir el desarrollo actual y más!
