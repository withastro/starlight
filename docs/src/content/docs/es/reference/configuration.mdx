...
Configurado en `false` para deshabilitar la indexación de tu sitio con Pagefind.
...
Los plugins aplican cambios a tu proyecto para modificar o agregar a las características de Starlight.
...
Ver la [Referencia de Plugins](/es/reference/plugins/) para obtener detalles sobre cómo crear tus propios plugins.