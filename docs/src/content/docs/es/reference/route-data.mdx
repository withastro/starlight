...
En el [middleware de ruta](/guides/route-data/#customizing-route-data), accede a los datos de ruta desde el objeto de contexto pasado a tu función de middleware:
...
Migra a la nueva API de Content Layer utilizando el [`docsLoader`](/manual-setup/#configure-content-collections) de Starlight y utiliza la propiedad [`id`](#id) en su lugar.
