...
Los apartados (también conocidos como "admoniciones" o "llamadas") son útiles para mostrar información secundaria junto al contenido principal de una página.
