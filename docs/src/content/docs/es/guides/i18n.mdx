...
```json
{
	...
	"search.devWarning": "La búsqueda solo está disponible en versiones de producción. \nIntenta construir y previsualizar el sitio para probarlo localmente.",
	...
	"i18n.untranslatedContent": "Este contenido aún no está disponible en tu idioma.",
	"page.editLink": "Editar página",
	"page.lastUpdated": "Actualizado:",
	"page.previousLink": "Siguiente",
   	"page.nextLink": "Anterior",
...
```json
{
	...
	"pagefind.alt_search": "No hay resultados para [SEARCH_TERM]. Mostrando resultados para [DIFFERENT_TERM] en su lugar",
	"pagefind.search_suggestion": "No hay resultados para [SEARCH_TERM]. Prueba con una de las siguientes búsquedas:",
