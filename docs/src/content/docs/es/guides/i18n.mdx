...
Adicionalmente a alojar archivos de contenido traducidos, Starlight te permite traducir las cadenas de UI predeterminadas (p. ej. el encabezado "En esta página" en la tabla de contenidos) para que tus lectores puedan experimentar tu sitio completamente en el idioma seleccionado.
...
Puedes proprocionar traducciones para idiomas adicionales que admitas, o anular nuestras etiquetas predeterminadas, a través de la colección de datos `i18n`.
