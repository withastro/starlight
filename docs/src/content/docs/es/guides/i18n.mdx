...
Starlight proporciona de forma predeterminada traducciones para los textos utilizados en la UI al inglés, alemán, japonés, portugués y español. También damos la bienvenida a [contribuciones para agregar más idiomas predeterminados](https://github.com/withastro/starlight/blob/main/CONTRIBUTING.md).
