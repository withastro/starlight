...
Starlight proporciona de forma predeterminada traducciones para los textos utilizados en la UI al inglés, francés, alemán, japonés, portugués y español. También damos la bienvenida a [contribuciones para agregar más idiomas predeterminados](https://github.com/withastro/starlight/blob/main/CONTRIBUTING.md).
...
Estos son los valores predeterminados en inglés de las cadenas existentes que se incluyen en Starlight:
   ...
   El modal de búsqueda de Starlight está impulsada por la biblioteca [Pagefind](https://pagefind.app/).
