...
Para excluir una página desde el índice de búsqueda, agrega [`pagefind: false`](/reference/frontmatter/#pagefind) al frontmatter de la página:
...
## Alternativa de proveedores de búsqueda
...
Agrega traducciones de la UI del modal para tu idioma usando el [sistema de internacionalización](/guides/i18n/#traduce-la-ui-de-starlight) incorporado de Starlight.
