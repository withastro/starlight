...
Esto puede ser útil, por ejemplo, al construir [sustituciones de componentes](https://www.google.com/search?q=/es/guides/overriding-components/) para personalizar lo que se muestra.
...
Este es un concepto similar a las [sustituciones de componentes](https://www.google.com/search?q=/es/guides/overriding-components/), pero en lugar de modificar cómo Starlight renderiza tus datos, modificas los datos que Starlight renderiza.
