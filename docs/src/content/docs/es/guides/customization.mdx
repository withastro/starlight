...
Actualmente, se admiten enlaces a Codeberg, Discord, GitHub, Mastodon y Twitter. ¡Háznoslo saber en GitHub o Discord si necesitas soporte para otro servicio!
