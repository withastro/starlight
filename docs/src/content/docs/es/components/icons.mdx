...
Un icono requiere un [`name`](#name) establecido en [uno de los iconos integrados de Starlight](/reference/icons/#todos-los-iconos) y opcionalmente puede incluir un [`label`](#label) para proporcionar contexto a los lectores de pantalla.
