...
En los archivos MDX y componentes de Astro, usa [el sufijo de importación `?raw` de Vite](https://vite.dev/guide/assets#importing-asset-as-string) para importar cualquier archivo de código como un string.
