...
Consulte as [instruções de instalação manual](/pt/manual-setup) para adicionar o Starlight a um projeto Astro já existente.
...
Isto irá criar um novo [diretório de projeto](/pt/guides/project-structure/) com todos os arquivos e configurações necessárias para o seu novo site.
...
O Starlight está pronto para você adicionar novos conteúdos, ou trazer os seus arquivos já existentes!

#### Formatos de arquivo

O Starlight suporta a escrita de conteúdo em Markdown e MDX sem precisar de nenhuma configuração extra.
Pode também adicionar suporte para Markdoc instalando a [integração experimental Astro Markdoc](https://docs.astro.build/pt/guides/integrations-guide/markdoc/).
...
Todas as páginas do Starlight partilham um [conjunto comum de propriedades frontmatter](/pt/reference/frontmatter/) para controlar como a página aparece:

```md
---
title: Olá, Mundo!
description: Esta é uma página no meu site com Starlight
---
```

Se você se esquecer de algum atributo importante, o Starlight irá informá-lo.

### Próximos passos

- **Configurar:** Descubra opções comuns em ["Customização do Starlight"](/pt/guides/customization/).
- **Navegar:** Configure a barra lateral com o guia [“Barra lateral de navegação”](/pt/guides/sidebar/).
- **Componentes:** Conheça os cartões, separadores e outros componentes integrados no guia [“Componentes”](/pt/guides/components/).
...
Utilize as páginas de referência [configuração do projeto](/pt/reference/configuration/) e [configuração do frontmatter para cada página](/pt/reference/frontmatter/) para garantir que seu site Starlight está configurado e a funcionar corretamente.
