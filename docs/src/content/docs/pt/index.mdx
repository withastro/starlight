...
<CardGrid stagger>
	<Card title="Documentação de iluminar os olhos" icon="open-book">
		...
		fácil de ler, <i>highlighting</i> de código, modo escuro e mais.
	</Card>
	...
	<Card title="Markdown, Markdoc e MDX" icon="document">
		Utilize a sua linguagem de marcação favorita. O Starlight inclui validação com
		<i>frontmatter</i> e segurança integrada de tipos com TypeScript.
	</Card>
