...
Currently, Starlight does not support [Server-Side rendering](https://docs.astro.build/en/guides/server-side-rendering/) for its pages, but you can use Starlight alongside SSR pages in your project. Starlight pages will always be prerendered regardless of your project's output mode.

We hope to be able to support SSR for Starlight pages soon.
