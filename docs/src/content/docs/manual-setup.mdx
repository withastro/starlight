...
This will install required dependencies and add Starlight to the `integrations` array in your Astro config file.
...
To add all Starlight pages at subpath, place all your docs content inside a subdirectory of `src/content/docs/`.
