...
Cela créera un nouveau [répertoire de projet](/guides/projet-structure/) avec tous les fichiers et configurations nécessaires pour votre site.
...
Starlight prend en charge la création de contenu en Markdown et MDX. (Vous pouvez ajouter la prise en charge de Markdoc en installant l'intégration expérimentale [Astro Markdoc integration](https://docs.astro.build/fr-fr/guides/integrations-guide/markdoc/).)
...
Toutes les pages Starlight partagent un [ensemble commun de propriétés de présentation](/fr-fr/reference/frontmatter/) personnalisable pour contrôler l'apparence de la page :
