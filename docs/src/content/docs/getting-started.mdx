...
{/* TODO(HiDeoo) Remove these filters. */}
...
<p>
	Tags:
	<span data-pagefind-filter="tag">new</span>
	<span data-pagefind-filter="tag">v1</span>
</p>

{/* TODO(HiDeoo) Remove these metadata. */}

<p data-pagefind-meta="npm">ready</p>
<p data-pagefind-meta="github">public</p>
