...
Starlight supports authoring content in Markdown and MDX. (There is experimental support for Markdoc available via the [Astro Markdoc integration](https://docs.astro.build/en/guides/integrations-guide/markdoc/).)
