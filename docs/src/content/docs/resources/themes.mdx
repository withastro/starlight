...
<ThemeGrid
	...
	themes={[
		...
		},
		{
			...
			description:
				'An arctic, north-bluish theme for Starlight, inspired by Nord Theme from Arctic Ice Studio',
		...
		},
		{
			...
			description:
				'A clean, modern theme with seamless sidebars and warm accents.',
		...
		},
		{
			...
			description:
				'A sharp, polished product-docs theme inspired by shadcn/ui.',
		...
		},
		{
			title: 'Starlight MD3',
			description:
				'A Material Design 3 and Material You-inspired theme with dynamic color roles, tonal surfaces, state layers, and motion.',
		...
		},
		{
			...
			description:
				"A theme that recreates rust-lang's mdBook look and feel, with its layout, chrome, and five built-in color schemes.",
		...
		},
		{
			title: 'Exquisitus',
			description:
				'A Starlight theme that blends readability and beauty without compromising on either.',
		...
		},
		{
			...
			description:
				'The classic Dracula palette, with Alucard as its light variant.',
		...
		},
		{
			...
			href: 'https://starlight-theme-large-print.chenlong365.workers.dev/',
