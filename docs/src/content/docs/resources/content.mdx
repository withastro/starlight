...
Recipes are typically short, focused how-to guides that walk a reader through completing a working example of a specific task. Recipes are a great way to add a new features or behavior to your Starlight project by following step-by-step instructions!
...
Here are some videos and channels with Starlight content, including live streams and educational content:
