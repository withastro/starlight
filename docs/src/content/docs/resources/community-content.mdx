...
<CardGrid>
	...
	<LinkCard
		...
		title="Make your Starlight sidebar items look better"
	...
	<LinkCard
		...
		title="Convention for better Starlight sidebars with middleware"
		description="Use middleware and your own convention to have better control of the order of sidebar items and group labels."
	/>
</CardGrid>
