...
Card with icon from the built-in default set:
...
Card with icon from the built-in `seti` set:
...
Card with icon from the user-installed Iconify `mdi` set:
...
Card with icon from the user `src/icons/` directory (`src/icons/test.svg`):
