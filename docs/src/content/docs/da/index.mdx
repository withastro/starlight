...
<CardGrid stagger>
	...
	<Card title="Drevet af Astro" icon="rocket">
		Udnyt den fulde kraft og udevne af Astro. 
		Udvid Starlight med dine yndlings Astro integrationer og biblioteker
	</Card>
	...
	<Card title="Anvend dine egne UI-komponenter" icon="puzzle">
		...
		Starlight bliver leveret som en fuldent dokumentations-løsning, der er ligeglad, med hvilket framework du bruger. Udvid med React, Vue, Svelte, Solid, og mere.
	</Card>
</CardGrid>
