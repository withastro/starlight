...
- **Withdrawable wallet, still self-custodial**: Your Axal account is built on Privy smart wallets that follow the ERC-7702 standard. You can make withdrawals at any time and remain in full control of your funds.
