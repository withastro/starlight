...
Weitere Informationen über [Verwendung von Komponenten in MDX](https://docs.astro.build/en/guides/integrations-guide/mdx/#using-components-in-mdx) findest du in der Astro-Dokumentation.
...
Weitere Informationen zur Verwendung von Komponenten in Markdoc-Dateien findst du in der [Astro Markdoc Integrationsdokumentation](https://docs.astro.build/de/guides/integrations-guide/markdoc/#komponenten-rendern).
...
Verwende den Typ [`ComponentProps`](https://docs.astro.build/de/guides/typescript/#componentprops-typ) aus `astro/types`, um auf die von einer Komponente akzeptierten `Props` zu verweisen, auch wenn sie nicht von der Komponente selbst exportiert werden.
