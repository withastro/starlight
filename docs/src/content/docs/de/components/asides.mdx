...
Überschreibe die Standard-Nebenfeldsymbole, indem du das Attribut [`icon`](#icon) auf den Namen [eines der in Starlight integrierten Symbole](/de/reference/icons/#alle-symbole) setzt.
...
<Aside type="tip" icon="starlight">
	Eine Warnung *mit* einem benutzerdefinierten Symbol.
</Aside>
```
