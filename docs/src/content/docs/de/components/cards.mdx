...
Zeige eine Karte an, indem du die Komponente `<Card>` verwendest und einen [`titel`](#titel) für die Karte angibst.
...
Zeige mehrere Karten nebeneinander an, wenn genügend Platz vorhanden ist, indem du sie mit der Komponente [`<CardGrid>`](/de/components/card-grids/) gruppierest.
