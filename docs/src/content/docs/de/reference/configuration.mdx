	...
	sidebar: [
		...
		// Eine Gruppe mit der Bezeichnung „Hier beginnen“, die vier Links enthält.
		{
			...
			items: [
				...
				{ slug: 'intro' },
				{ slug: 'installation' },
				// Oder Sie verwenden die Abkürzung für interne Links.
				'tutorial',
				'next-steps',
			],
		},
...
Wenn du lokale Elemente wie Skripte, Stile oder Bilder importieren musst, [überschreibe die Komponente Head](/guides/overriding-components/#reuse-a-built-in-component).
...
Siehe die [Plugins Referenz](/de/reference/plugins/) für Details zur Erstellung eigener Plugins.
