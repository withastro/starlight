...
Siehe die [Referenz: Ersetzung](/de/reference/overrides/) für Details zu allen Komponenten, die du überschreiben kannst.
...
Siehe die [Referenz: Plugins](/de/reference/plugins/) für Details zur Erstellung eigener Plugins.
