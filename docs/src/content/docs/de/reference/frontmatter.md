...
Da Entwurfsseiten nicht in die Build-Ausgabe aufgenommen werden, kannst du keine Entwurfsseiten direkt mit [Slugs](/guides/sidebar/#interne-links) zu deiner Seitenleistenkonfiguration hinzufügen.
Entwurfsseiten in Verzeichnissen, die für [autogenerierte Seitenleisten-Gruppen](/guides/sidebar/#automatisch-erzeugte-gruppen) verwendet werden, werden bei Produktions-Builds automatisch ausgeschlossen.
