...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			description="Erweitere Starlights Markdown-Nebenbemerkungs-Syntax um eigene Blocktypen."
		/>
		<LinkCard
		...
		<LinkCard
			...
			description="Ein Komponentensatz zur API-Dokumentation im Swagger-Stil, zur Dokumentation von Klassen, Methoden, Eigenschaften und Typen, mit themenbezogener Syntaxhervorhebung – und das alles im Light DOM."
		/>
		<LinkCard
			href="https://github.com/andriygm/starlight-base-path/"
			title="starlight-base-path"
			description="Füge zu all deinen Links in deinen Inhalten automatisch einen einstellbaren Basis-Pfad als Präfix hinzu."
		/>
		<LinkCard
			href="https://github.com/trueberryless-org/starlight-recipes/"
			title="starlight-recipes"
			description="Starlight-Plugin zum Erstellen einer Rezept-Website."
		/>
		<LinkCard
			href="https://github.com/max-ostapenko/starlight-md-txt"
			title="starlight-md-txt"
			description="Stelle deine Starlight-Dokumentationsseiten als reines, agentenfreundliches Markdown unter .md.txt-URLs bereit."
		/>
		<LinkCard
			href="https://github.com/TechDocsStudio/starlight-biel"
			title="starlight-biel"
			description="Füge einen „Ask AI“-Chatbot hinzu, der auf der Grundlage deiner Inhalte antwortet – unterstützt von Biel.ai."
		/>
		<LinkCard
			href="https://github.com/babblebey/starlight-page-context-action"
			title="starlight-page-context-action"
			description="Mach nützliche Aktionen wie „Seite als Markdown kopieren/anzeigen“, „Im KI-Chat öffnen“ oder „Nach oben scrollen“ in deiner Dokumentation jederzeit verfügbar."
		/>
		<LinkCard
		...
		<LinkCard
			...
			description="Füge seitliche Navigationsleisten, schwebende Schaltflächen, Tastaturkürzel und Wischgesten zum Wechseln zwischen Seiten hinzu."
		/>
		<LinkCard
			href="https://github.com/HiDeoo/starlight-to-skills"
			title="starlight-to-skills"
			description="Verwandle Starlight-Dokumentationsseiten in geprüfte, auffindbare und aktuelle Agent-Skills."
		/>
	</CardGrid>
</ThirdPartyContent>
...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			description="Zeige schnell einen Link zu einem Download-Asset auf deiner Starlight-Website an."
		/>
		<LinkCard
			href="https://github.com/trueberryless-org/starlight-contributor-list"
			title="starlight-contributor-list"
			description="Zeige eine Liste aller Leute an, die zu deinem Projekt beigetragen haben."
		/>
		<LinkCard
			href="https://github.com/pixelizing/axiom-studio-for-starlight"
			title="Axiom Studio für Starlight"
			description="Ein lokaler Browser-Editor zum Bearbeiten von Markdown- und MDX-Seiten, Verwalten von Frontmatter und Anzeigen einer Vorschau der Starlight-Dokumentation, ohne die Dateien anzufassen."
		/>
		<LinkCard
			href="https://github.com/joesaby/astro-archify"
			title="astro-archify"
			description="Rendert Archify-Systemdiagramme aus JSON-IR-Code-Blöcken während der Kompilierung. Kompatibel mit Astro und Starlight."
		/>
	</CardGrid>
</ThirdPartyContent>
