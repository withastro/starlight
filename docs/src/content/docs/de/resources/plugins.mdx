...
<CardGrid>
	...
	<LinkCard
		...
		description="Erstelle Dokumentations&shy;seiten aus OpenAPI/Swagger-Spezifikationen."
	/>
	<LinkCard
	...
	<LinkCard
		...
		description="Versioniere deine Starlight-Dokumentations&shy;seiten."
	/>
	<LinkCard
...
Ein Theme ist ein Starlight-Plugin, das das visuelle Erscheinungsbild einer Website mit Komponenten&shy;überschreibungen, benutzerdefiniertem CSS oder anderen neuen Funktionen verändert.
