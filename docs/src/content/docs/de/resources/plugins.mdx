...
<CardGrid>
	...
	<LinkCard
		...
		description="Hinzufügen von browser-nativen, dokumentations&shy;übergreifenden Ansichtsübergängen."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starlight-auto-sidebar"
		title="starlight-auto-sidebar"
		description="Optimiere deine automatisch generierten Seitenleistengruppen."
	/>
</CardGrid>
