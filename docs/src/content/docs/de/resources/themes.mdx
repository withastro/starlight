...
<ThemeGrid
	...
	themes={[
		...
		},
		{
			...
			description:
				'Ein arktisches, nordisch-bläuliches Design für Starlight, inspiriert vom „Nord Theme“ von Arctic Ice Studio.',
		...
		},
		{
			...
			description:
				'Ein maßgeschneidertes Astro-Starlight-Design, das moderne und Retro-Elemente vereint.',
		...
		},
		{
			...
			description:
				'Ein schlichtes, modernes Design mit nahtlosen Seitenleisten und warmen Akzenten.',
		...
		},
		{
			...
			description:
				'Ein elegantes, poliertes Theme für Produktdokumentationen, inspiriert von shadcn/ui.',
		...
		},
		{
			title: 'Starlight MD3',
			description:
				'Ein von Material Design 3 und Material You inspiriertes Design mit dynamischen Farbrollen, farblich abgestimmten Oberflächen, Statusebenen und Animationen.',
		...
		},
		{
			...
			description:
				'Ein Theme, das das Look-and-Feel von rust-langs mdBook nachbildet – inklusive Layout, der typischen Benutzeroberfläche und den fünf integrierten Farbschemata.',
		...
		},
		{
			title: 'Exquisitus',
			description:
				'Ein Starlight-Theme, das Lesbarkeit und Ästhetik vereint, ohne bei beidem Abstriche zu machen.',
			href: 'https://starlight-theme-exquisitus.aka-300.workers.dev/',
			previews: { light: 'exquisitus-light.png', dark: 'exquisitus-dark.png' },
		},
		{
			title: 'Dracula für Starlight',
			description:
				'Die klassische Dracula-Farbpalette, mit Alucard als heller Variante.',
			href: 'https://wasi-master.github.io/dracula-for-starlight/',
			previews: { light: 'dracula-light.png', dark: 'dracula-dark.png' },
		},
	]}
/>
