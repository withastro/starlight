...
Ein Theme ist ein Starlight-Plugin, welches das Erscheinungsbild einer Website mit [benutzerdefiniertem CSS](/guides/css-and-tailwind/), [Komponenten&shy;ersetzung](/guides/overriding-components/) oder anderen neuen Funktionen verändert.
