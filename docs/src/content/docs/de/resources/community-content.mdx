...
<CardGrid>
	...
	<LinkCard
		...
		title="Verpass deiner Starlight-Seitenleiste eigene Stile"
	...
	<LinkCard
		...
		description="Kombiniere zwei Plugins, um das Beste aus beiden auf Desktop- und Mobilgeräten zu haben."
	/>
	<LinkCard
		...
		description="Benutz Route-Middleware, um die Reihenfolge der Seitenleisten und Gruppenbeschriftungen zu steuern, inspiriert von den Konventionen von Nuxt Content."
	/>
</CardGrid>
