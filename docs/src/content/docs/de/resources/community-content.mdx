...
<CardGrid>
	...
	<LinkCard
		...
		description="Wie Cloudflare Starlight benutzt hat, um seine Entwicklerdokumentation zu verbessern."
	/>
</CardGrid>
...
<YouTubeGrid
	videos={[
		...
		},
		{
			...
			title:
				'Astro Starlight Dokumentationsvorlage (Erstelle eigene Applikations-Dokumentation!)',
			description:
