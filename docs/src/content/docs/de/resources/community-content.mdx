...
<CardGrid>
	...
	<LinkCard
		...
		title="Vergleich von Dokumentations&shy;seiten-Frameworks: VuePress vs. Starlight"
	...
	<LinkCard
		...
		title="Aufbau einer Dokumentationsseite mit Astro Starlight"
...
<CardGrid>
	...
	<LinkCard
		...
		description="Lerne, wie du dynamische JSON-LD strukturierte Daten für deine Dokumentations&shy;seiten erstellst."
	/>
	<LinkCard
		href="https://starlight-examples.netlify.app/"
		title="Starlight Beispiele"
		description="Eine Sammlung von StackBlitz-Einbettungen, die zeigen, wie man in Starlight-Dokumentations&shy;seiten praktische Dinge tun kann."
	/>
</CardGrid>
