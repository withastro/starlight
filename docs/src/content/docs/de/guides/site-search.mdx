...
Füge mithilfe des in Starlight integrierten [Internationalisierungssystems](/de/guides/i18n/#Übersetzen-der-Benutzeroberfläche-von-starlight) Übersetzungen der Benutzeroberfläche der Modale für deine Sprache hinzu.
