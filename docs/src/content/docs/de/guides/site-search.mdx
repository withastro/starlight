...
Füge mithilfe des in Starlight integrierten [Internationalisierungssystems](/de/guides/i18n/#starlights-ui-%C3%BCbersetzen) Übersetzungen der Benutzeroberfläche der Modale für deine Sprache hinzu.
