...
**Typ:** [`SidebarItem[]`](/reference/configuration/#sidebaritem)  
	...
	sidebar={[
		{ label: 'Home', link: '/' },
		{
			...
			items: [
				...
				{ label: 'Ursa Minor', link: '/ursa-minor/', Abzeichen: 'Stub' },
			],
		},
	]}
>
...
**Typ:** `boolean`  
**Voreinstellung:** `false` wenn [`frontmatter.template`](/reference/frontmatter/#template) `'splash'` ist, sonst `true`
