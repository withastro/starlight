...
<YouTubeGrid
	videos={[
		...
		},
		{
			...
			title:
				'Inclua a documentação Startligth num projecto Next.js através de proxies',
			description:
				'Configurar o Startlight como uma sub-directoria dentro de um site Next.js',
		},
		{
			...
			description:
				'Neste video eu abordo o que torna o Starligh tão porreiro e porque razão deve experimentá-lo no seu próximo projecto.',
		},
	]}
/>
