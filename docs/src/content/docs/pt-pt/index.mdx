...
<TestimonialGrid title="O que dizem acerca de nós">
  ...
  >
		...
		e a rapidez do Starligth, e as ferramentas do Starlight, é uma combinação feita no céu.

		Tem sido a minha escolha de eleição há algum tempo, e continua a adorá-lo!
  ...
  >
		Utilizei o Starligh no meu último trabalho e adorei-o! Componentes fantásticos,
