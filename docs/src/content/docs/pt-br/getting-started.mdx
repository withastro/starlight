...
:::caution[Trabalho em progresso]
Starlight está em desenvolvimento antecipado.
Se você encontrar algo que não está funcionando, [abra uma issue no GitHub](https://github.com/withastro/starlight/issues/new/choose) ou nos informe no [Discord](https://astro.build/chat).
:::
...
Você também pode conseguir ajuda no [Discord do Astro](https://astro.build/chat/) da nossa ativa e amigável comunidade! Você pode postar perguntas em nosso fórum `#support` ou visitar nosso canal dedicado `#starlight` para discutir o desenvolvimento atual e mais!
