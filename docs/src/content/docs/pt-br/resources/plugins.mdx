...
[Plugins](/reference/plugins/) podem personalizar a configuração Starlight, a interface do usuário e o comportamento, enquanto também são fáceis de compartilhar e de reutilizar.
...
<CardGrid>
	...
	<LinkCard
		...
		description="Adicione um blog no site de sua documentação."
	/>
	<LinkCard
