...
Privy is the wallet infrastructure embedded inside Axal AutoYield. Think of it as the secure plumbing that lets you use the dApp without installing a separate browser extension or juggling seed phrases.
