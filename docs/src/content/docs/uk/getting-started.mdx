...
У директорії вашого проєкту виконайте наступну команду, щоби запустити розробницький сервер:
...
У термінал видрукуєтсья URL локального сервера.
Відкрийте цей URL, щоби переглянути сайт.
...
Наприклад, наступна структура файлів зґенерує сторінки за адресами `example.com/hello-world` і `example.com/guides/faq`:
...
У Starlight усі сторінки поділяють налаштовуваний [спільний набір властивостей преамбули](/uk/reference/frontmatter/), якими визначається вигляд сторінки:
...
- **Розгортування:** Опублікуйте свою роботу за допомогою посібника [“Розгорніть свій сайт”](https://docs.astro.build/guides/deploy/) в документації Astro.
...
Starlight є інтеґрацією Astro, а отже ви можете оновити його так само, як і решту пакетів Astro, ─ виконавши в терміналі наступну команду:
