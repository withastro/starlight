...
Consultez le guide [« Getting Started »](https://starlight-docsearch.typesense.org/getting-started/) dans la documentation de Starlight DocSearch de Typesense pour apprendre comment l’utiliser dans votre projet.
