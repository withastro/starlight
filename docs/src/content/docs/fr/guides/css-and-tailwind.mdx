...
<ThemeDesigner
	labels={{
		...
		preview: {
			...
			dimText: 'Certains textes, comme la table des matières, ont un contraste plus faible.',
...
>
	<Fragment slot="css-docs">
		...
		personnalisé](#styles-css-personnalisés) pour appliquer ce thème à votre site.
	</Fragment>
	<Fragment slot="tailwind-docs">
		Le fichier d'exemple de [configuration Tailwind](#mettre-en-forme-starlight-avec-tailwind) ci-dessous
		inclut les palettes de couleurs `accent` et `gray` générées à utiliser dans l'objet de
