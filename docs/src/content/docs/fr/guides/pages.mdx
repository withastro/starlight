...
<StarlightPage
	...
	sidebar={[
		{ label: 'Home', href: '/' },
		{
			...
			items: [
				{ label: 'Andromède', href: '/andromeda/' },
				{ label: 'Orion', href: '/orion/', isCurrent: true },
				{ label: 'La Petite Ourse', href: '/ursa-minor/', badge: 'Stub' },
			],
		},
	]}
>
