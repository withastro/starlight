...
L'exemple suivant lit les paramètres régionaux actuels et l'utilise avec l'aide de [`getRelativeLocaleUrl()`](https://docs.astro.build/fr/reference/api-reference/#getrelativelocaleurl) pour générer un lien vers une page d'information dans la langue actuelle :
