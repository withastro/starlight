...
```astro {3}
<!-- src/components/Exemple.astro -->
<a href="https://docs.astro.build/fr/guides/actions/">
	{Astro.locals.t('link.astro.custom', { feature: 'Astro Actions' })}
</a>
<!-- Affiche: <a href="...">Documentation d'Astro pour Astro Actions</a> -->
```
...
<a href={getRelativeLocaleUrl(Astro.currentLocale ?? 'en', 'about')}>
	À propos
</a>
```
