...
<LanguagesList startsSentence /> les chaînes traduites de l'UI sont livrées de base,
et nous accueillons volontiers [les contributions visant à ajouter d'autres langues par défaut](https://github.com/withastro/starlight/blob/main/CONTRIBUTING.md).
