...
Faire ressortir un fichier ou un répertoire en mettant son nom en gras, par exemple `**README.md**`.
...
### Ajouter des espaces vierges

Ajoutez des fichiers et des répertoires de remplacement en utilisant soit `...` soit `…` comme nom.
...
Le composant `<FileTree>` n'accepte aucun props.