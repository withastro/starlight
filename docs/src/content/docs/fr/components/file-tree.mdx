...
Échappez les caractères spéciaux tels que les traits de soulignement ou les espaces dans les noms de fichiers en enveloppant le nom de fichier avec des accents graves.
