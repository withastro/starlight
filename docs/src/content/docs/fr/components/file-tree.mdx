...
### Afficher une icône différente de l’extension de fichier

Ajoutez une barre verticale `|` après le nom du fichier, suivie de l’extension à utiliser, afin de définir une icône différente de celle déduite automatiquement à partir de l’extension.
...
- src
  - components
    - Header.astro basé sur l’extension du nom de fichier
    - Header.astro|mdx en spécifiant l’extension à utiliser
