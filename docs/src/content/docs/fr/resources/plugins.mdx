...
<CardGrid>
	...
	<LinkCard
		...
		description="Ajouter des transitions de vue natives entre vos pages."
	/>
	<LinkCard
	...
	<LinkCard
		...
		description="Étend les composants d'interface utilisateur de base avec des liens de navigation personnalisés, des publicités, des pieds de page axés marketing et un bouton de thème plus épuré."
	/>
</CardGrid>
