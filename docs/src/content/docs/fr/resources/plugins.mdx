...
<CardGrid>
	...
	<LinkCard
		...
		description="Ajoutez un graphique de site interactif dans la barre latérale de votre page."
	/>
</CardGrid>
...
<CardGrid>
	...
	<LinkCard
		...
		description="Thème Starlight inspiré par le style des sites de publication d'Obsidian."
	/>
</CardGrid>
