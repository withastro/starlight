...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			description="Ensemble de composants pour la documentation d'API, dans le style de Swagger, qui affiche la documentation des classes, des méthodes, des propriétés et des types avec une coloration syntaxique adaptée au thème, le tout dans le DOM principal."
		/>
		<LinkCard
			href="https://github.com/andriygm/starlight-base-path/"
			title="starlight-base-path"
			description="Préfixer automatiquement le chemin de base configuré aux liens présents dans votre contenu."
		/>
		<LinkCard
		...
		<LinkCard
			...
			description="Faire en sorte que les actions telles que copier/voir la page au format markdown, ouvrir dans le chat IA et faire défiler vers le haut soient toujours accessibles dans votre documentation."
		/>
		<LinkCard
			href="https://github.com/AshutoshRaj97/agentready-mcp/tree/main/starlight-plugin"
			title="starlight-agentready"
			description="Soumettez votre documentation à AgentReady après chaque compilation afin de la rendre interrogeable par des agents d'IA via MCP."
		/>
		<LinkCard
			href="https://github.com/ewels/starlight-pydocs"
			title="starlight-pydocs"
			description="Documentation d'API Python automatisée pour Astro et Starlight, utilisant l'analyse statique."
		/>
		<LinkCard
			href="https://github.com/ewels/starlight-quiz"
			title="starlight-quiz"
			description="Quiz interactifs pour Astro et Starlight, rédigés en Markdown et incluant un suivi complet de la progression."
		/>
		<LinkCard
			href="https://frostybee.github.io/starlight-custom-navigation/"
			title="starlight-custom-navigation"
			description="Ajouter des bandeaux de navigation latéraux, des boutons flottants, des raccourcis clavier et des gestes de balayage pour naviguer entre les pages."
		/>
		<LinkCard
			href="https://github.com/HiDeoo/starlight-to-skills"
			title="starlight-to-skills"
			description="Transformez les pages de documentation de Starlight en compétences d'agent (« skills » en anglais) vérifiées, faciles à trouver et à jour."
		/>
	</CardGrid>
</ThirdPartyContent>
...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			title="astro-archify"
			description="Générer lors de la compilation des diagrammes système Archify à partir de blocs de code JSON IR. Fonctionne avec Astro et Starlight."
		/>
	</CardGrid>
</ThirdPartyContent>
