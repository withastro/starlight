...
<ThemeGrid
	...
	themes={[
		...
		},
		{
			...
			description:
				"Un thème arctique aux teintes bleutées nordiques pour Starlight, inspiré du thème Nord d'Arctic Ice Studio.",
		...
		},
		{
			...
			description:
				'Un thème Astro Starlight personnalisé combinant des éléments modernes et rétro.',
		...
		},
		{
			...
			description:
				'Un thème épuré et moderne avec des barres latérales discrètes et des couleurs chaleureuses.',
		...
		},
		{
			...
			description:
				'Un thème de documentation produit soigné et élégant, inspiré de shadcn/ui.',
		...
		},
		{
			title: 'Starlight MD3',
			description:
				"Un thème inspiré de Material Design 3 et Material You avec des rôles de couleur dynamiques, des surfaces contrastées, des couches d'état et des animations.",
		...
		},
		{
			title: 'Exquisitus',
			description:
				"Un thème Starlight qui allie lisibilité et esthétique sans faire de compromis sur l'une ou l'autre.",
