...
<CardGrid>
	...
	<LinkCard
		...
		title="Menu déroulant Starlight Topics sur mobile, liste sur ordinateur"
	...
	<LinkCard
		...
		title="Traitement des barres latérales de Starlight avec un middleware"
		description="Utilisez un middleware de routage pour contrôler l'ordre des barres latérales et les étiquettes de groupe, inspiré des conventions de Nuxt Content."
	/>
</CardGrid>
