...
<CardGrid>
	...
	<LinkCard
		...
		title="Personnalisation de la barre latérale de Starlight pour le contenu protégé par authentification"
		description="Sécurisez votre matériel de cours en utilisant Clerk et SSR pour masquer ou afficher dynamiquement les chapitres dans la barre latérale de Starlight en fonction de l'état de connexion de l'utilisateur."
	/>
</CardGrid>
