...
Désactive l'injection de la [page 404](https://docs.astro.build/fr/core-concepts/astro-pages/#custom-404-error-page) par défaut de Starlight. Pour utiliser une route personnalisée `src/pages/404.astro` dans votre projet, mettez cette option à `false`.
