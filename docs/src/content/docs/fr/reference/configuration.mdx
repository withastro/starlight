...
Si vous avez besoin d'importer des ressources locales comme des scripts, des styles ou des images, [réutilisez le composant Head](/guides/overriding-components/#réutiliser-un-composant-intégré).
