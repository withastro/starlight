...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			description="ページタイトルにある洗練されたボタンで、ドキュメントのMarkdown全文をコピーします。"
		/>
		<LinkCard
			href="https://frostybee.github.io/starlight-telescope/"
			title="starlight-telescope"
			description="曖昧検索とキーボード中心の操作により、Starlightドキュメント内のあらゆるページへ素早く移動します。"
		/>
		<LinkCard
			href="https://frostybee.github.io/starlight-announcement/"
			title="starlight-announcement"
			description="Starlightで作成したドキュメントに、非表示機能、バリエーション、スケジュール設定、ページ指定などの機能を備えた高度な告知バナーを追加します。"
		/>
	</CardGrid>
</ThirdPartyContent>
