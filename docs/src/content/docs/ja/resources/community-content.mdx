...
<ThirdPartyContent>
	<CardGrid>
		...
		<LinkCard
			...
			title="認証が必要なコンテンツ向けにAstro Starlightのサイドバーをカスタマイズする"
			description="ClerkとSSRを活用し、ユーザーのログイン状況に応じてStarlightのサイドバーの章を動的に非表示、あるいは表示することで、コース教材へのアクセスを制御する方法を紹介しています。"
		/>
	</CardGrid>
</ThirdPartyContent>
