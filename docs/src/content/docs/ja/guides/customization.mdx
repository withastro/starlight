...
現在、Bitbucket、Codeberg、CodePen、Discord、GitHub、GitLab、Gitter、LinkedIn、Mastodon、Microsoft Teams、Threads、Twitch、Twitter、YouTubeへのリンクがサポートされています。他のサービスのサポートが必要な場合は、GitHubまたはDiscordでお知らせください！
