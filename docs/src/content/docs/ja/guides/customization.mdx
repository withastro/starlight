...
現在、Bitbucket、Codeberg、CodePen、Discord、Eメール、Facebook、GitHub、GitLab、Gitter、Instagram、LinkedIn、Mastodon、Microsoft Teams、Reddit、RSSフィード、Stack Overflow、Telegram、Threads、Twitch、Twitter、X、YouTubeへのリンクがサポートされています。他のサービスのサポートが必要な場合は、GitHubまたはDiscordでお知らせください！
