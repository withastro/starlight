...
Starlightは、実験的な[Astro Markdoc統合](https://docs.astro.build/en/guides/integrations-guide/markdoc/)とStarlight Markdocプリセットを使用して、Markdocでのコンテンツ作成をサポートしています。
...
Markdocの構文と機能についてさらに学ぶには、[Markdocのドキュメント](https://markdoc.dev/docs/syntax)または[Astro Markdoc統合ガイド](https://docs.astro.build/en/guides/integrations-guide/markdoc/)を参照してください。
