...
[GitHub上の`props.css`ファイル](https://github.com/withastro/starlight/blob/main/packages/starlight/src/style/props.css)で、サイトをカスタマイズするために設定可能な、Starlightが使用しているすべてのカスタムCSSプロパティを確認できます。
