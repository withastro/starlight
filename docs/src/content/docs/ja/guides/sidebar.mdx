...
starlight({
	sidebar: [
		// ガニメデページへのリンク。
		{ label: 'ガニメデ', link: '/moons/ganymede/' },
		// NASAのウェブサイトへの外部リンク。
...
starlight({
	sidebar: [
		// 「星座」というラベルのリンクグループ。
		{
			label: '星座',
			items: [
				{ label: 'りゅうこつ座', link: '/constellations/carina/' },
				{ label: 'ケンタウルス座', link: '/constellations/centaurus/' },
				// 季節の星座の入れ子になったリンクグループ。
				{
					label: '季節の星座',
					items: [
						{ label: 'アンドロメダ座', link: '/constellations/andromeda/' },
						{ label: 'オリオン座', link: '/constellations/orion/' },
						{ label: 'こぐま座', link: '/constellations/ursa-minor/' },
					],
				},
			],
		},
