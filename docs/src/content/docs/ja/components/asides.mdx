...
値には、[Starlightの組み込みアイコン](/ja/reference/icons/#all-icons)の名前を指定します。
...
**型:** [`StarlightIcon`](/ja/reference/icons/#starlighticon-type)

補足情報に`icon`属性を設定して、[Starlightの組み込みアイコン](/ja/reference/icons/#all-icons)の名前を指定できます。
