...
[Starlightの組み込みアイコン](/ja/reference/icons/#all-icons)の名前を[`icon`](#icon)属性に設定して、カードにアイコンを含めることができます。
...
[`<CardGrid>`](/components/card-grids/)コンポーネントを使用してグループ化することで、十分なスペースがある場合に複数のカードを並べて表示できます。
例については、["カードのグループ化"](/ja/components/card-grids/#group-cards)ガイドを参照してください。
...
カードには[Starlightの組み込みアイコン](/ja/reference/icons/#all-icons)の名前に設定された`icon`属性を含めることができます。
