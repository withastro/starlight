...
ファイル名にアンダースコアやスペースなどの特殊文字が含まれる場合は、ファイル名をバッククォートで囲んでエスケープしてください。
...
**実装:** [`FileTree.astro`](https://github.com/withastro/starlight/blob/main/packages/starlight/src/user-components/FileTree.astro)
