...
The example below shows a custom component that reuses the `TwoColumnContent` component which contains an additional `end-sidebar` named slot that needs to be transferred:
