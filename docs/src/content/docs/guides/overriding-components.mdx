...
- If the component you want to override uses one or more [slots](https://docs.astro.build/en/core-concepts/astro-components/#slots), make sure to pass them through if you do not wish to remove them. This can be achieved by [transferring slots](https://docs.astro.build/en/basics/astro-components/#transferring-slots).
...
If the component you want to conditionally override uses one or more [slots](https://docs.astro.build/en/core-concepts/astro-components/#slots), make sure to pass them through to the default UI.

```astro
---
// src/components/ConditionalPageFrame.astro
import type { Props } from '@astrojs/starlight/props';
