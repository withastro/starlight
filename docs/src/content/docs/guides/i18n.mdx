...
English, Czech, French, German, Italian, Japanese, Portuguese, Dutch and Spanish translated UI strings are provided out of the box, and we welcome [contributions to add more default languages](https://github.com/withastro/starlight/blob/main/CONTRIBUTING.md).
