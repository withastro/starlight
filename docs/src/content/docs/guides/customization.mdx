...
You can find a list of all the CSS custom properties used by Starlight that you can use or override to customize your site in this [file](https://github.com/withastro/starlight/blob/main/packages/starlight/style/props.css).
