...
To apply the font you set up to your site, use your chosen font’s name in a [custom CSS file](/id/guides/css-and-tailwind/#custom-css-styles).
...
Follow the [custom CSS instructions](/id/guides/css-and-tailwind/#custom-css-styles) to add your styles to your site.
