...
Starlight has built-in support for sitemaps, you can read more about [how to enable it here](https://docs.astro.build/en/guides/integrations-guide/sitemap/#usage).
