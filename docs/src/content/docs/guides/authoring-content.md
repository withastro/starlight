...
Starlight supports all other common Markdown authoring syntax, such as lists and tables. See the [Markdown documentation](https://daringfireball.net/projects/markdown/) for all the options available.
