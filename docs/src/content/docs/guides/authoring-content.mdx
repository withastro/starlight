...
Footnotes[^1] are useful for adding brief references or clarifications without interrupting the flow of your content. They appear as superscript links that jump to referenced text collected at the bottom of the page.
