...
<CardGrid>
  <LinkCard
    icon="star"
    link="#link-cards"
    title="Title with icon and description"
    description="Lorem ipsum dolor sit amet, consectetur adipiscing elit."
  />
    <LinkCard link="#link-cards" title="Title with no icon" description="Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." />

  <LinkCard icon="setting" link="#link-cards" title="Title and Icon" />
  <LinkCard link="#link-cards" title="Title Only" />
</CardGrid>
