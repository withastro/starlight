...
<LinkCard
  href="#link-cards"
  heading="A single card by itself"
...
<CardGrid>
  <LinkCard
    href="#link-cards"
    heading="Title with description"
    description="Lorem ipsum dolor sit amet, consectetur adipiscing elit."
  />
  <LinkCard href="#link-cards" heading="Title Only" />
  <LinkCard
    href="#link-cards"
    heading="Card with a long title that wraps plus a description"
    description="Lorem ipsum dolor sit amet, consectetur adipiscing elit."
  />
</CardGrid>
