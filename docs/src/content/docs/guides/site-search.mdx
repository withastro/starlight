...
The [Starlight DocSearch Typesense](https://starlight-docsearch-typesense-docs.vercel.app/) community plugin provides a self-hosted and open-source alternative which integrates the [DocSearch](https://docsearch.algolia.com/) interface with a [Typesense](https://typesense.org/) backend.

Check the [“Getting Started”](https://starlight-docsearch-typesense-docs.vercel.app/getting-started/) guide in the Starlight DocSearch Typesense plugin documentation to use it instead of Pagefind.
