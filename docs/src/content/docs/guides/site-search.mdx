...
[Community plugins](/resources/plugins/#community-plugins) can also provide alternatives to the built-in search provider.
Replace Starlight’s default Pagefind search with one of the following community-developed options.

#### Typesense DocSearch

The [Starlight DocSearch Typesense](https://starlight-docsearch.typesense.org/) community plugin provides an open-source and self-hostable alternative which integrates the [DocSearch](https://github.com/typesense/typesense-docsearch.js) interface with a [Typesense](https://typesense.org/) backend.

Check the [“Getting Started”](https://starlight-docsearch.typesense.org/getting-started/) guide in the Starlight DocSearch Typesense plugin documentation to use it instead of Pagefind.
