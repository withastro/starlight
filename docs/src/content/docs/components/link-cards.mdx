---
title: Link Cards
description: Learn how to display links prominently with the LinkCard component.
sidebar:
  order: 3
---
...
Include a short description in a link card using the [`description`](#description) attribute.
...
The `<LinkCard>` component accepts the following props and also any [other `<a>` attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a):
