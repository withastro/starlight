---
title: Steps
description: Learn how to style numbered lists of tasks to create step-by-step guides.
---

import { Tabs, TabItem, Steps } from '@astrojs/starlight/components';

To style a numbered lists of tasks to create step-by-step guides, use the `<Steps>` component.
