...
Bu, siten için yapılandırmalar ve tüm gerekli dosyalarla birlikte yeni bir [proje dizini](/guides/project-structure/) oluşturacaktır.
...
Tüm Starlight sayfaları özelleştirilebilir [ortak ön-bölüm mülkleri seti](/reference/frontmatter/)'ni, sayfaların nasıl görüntüleneceğini kontrol etmek için paylaşır:
...
Starlight [Proje Yapılandırması](/reference/configuration/) ve [Benzersiz Sayfa Ön-bölüm Yapılandırması](/reference/frontmatter/) bilgileri, bu sitenin referanslar bölümünde mevcuttur. Bu sayfalardan, Starlight siteni doğru yapılandırdığından ve sitenin düzgün çalıştığından emin olmak için kullanabilirsin.
