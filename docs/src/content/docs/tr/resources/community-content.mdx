...
<CardGrid>
	...
	<LinkCard
		...
		description="Maxi Ferreira and Ben Holmes Starlight, TinaCMS ve yetkilendirmeli interaktif API oyunalanı ile dokümantasyon sitesi oluşturuyor."
	/>
	<LinkCard
...
<YouTubeGrid
	videos={[
		...
		},
		{
			...
			description: 'Ben\'in bir dakikadan kısa sürede yeni bir Starlight sitesi açmasını izleyin!',
		},
	]}
/>
...
<YouTubeGrid
	videos={[
		...
		},
		{
			...
			title: 'Astro Starlight Belgelendirme Şablonu (özel uygulama belgeleri oluşturun!)',
			description: 'Yaklaşık 5 dakika içinde yeni bir Starlight sitesini çalışır duruma getirin',
		},
		{
		...
		},
		{
			...
			title: "Bu Harika Araçla Shadcn'in Dokümanlarını 30 Dakikada Yeniden Oluşturdum",
			description:
