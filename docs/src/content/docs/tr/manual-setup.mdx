...
Yeni bir Starlight sitesi yapmanın en hızlı yolu, [Başlangıç Rehberi](/getting-started/#creating-a-new-project)'nde gösterildiği gibi `create astro` komutunu kullanmak.
