...
Yeni bir Starlight sitesi yapmanın en hızlı yolu, [Başlangıç Rehberi](/tr/getting-started/#creating-a-new-project)'nde gösterildiği gibi `create astro` komutunu kullanmak.
...
```
Geçerli olan tüm ayarları [Starlight Yapılandırma Referansı](/reference/configuration/)'nda bulabilirsin.
...
Geçerli olan tüm ayarları [frontmatter referansı](/reference/frontmatter/)'nda görebilirsin.
