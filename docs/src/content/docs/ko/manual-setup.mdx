...
The quickest way to create a new Starlight site is using `create astro` as shown in the [Getting Started guide](/ko/getting-started/#creating-a-new-project).
...
Find all available options in the [Starlight configuration reference](/ko/reference/configuration/).
...
See all the available options in the [frontmatter reference](/ko/reference/frontmatter/).
