...
<ThemeGrid
	...
	themes={[
		...
		},
		{
			...
			description:
				'Arctic Ice Studio의 Nord 테마에서 영감을 받은, Starlight를 위한 북극의 푸른색 테마',
		...
		},
		{
			...
			description:
				'현대적인 요소와 레트로한 요소가 결합된 맞춤형 Astro Starlight 테마',
		...
		},
		{
			...
			description:
				'심리스한 사이드바와 따뜻한 강조색을 갖춘 깔끔하고 현대적인 테마',
		...
		},
		{
			...
			description: 'shadcn/ui에서 영감을 받은 세련되고 정교한 제품 문서 테마',
		...
		},
		{
			title: 'Starlight MD3',
			description:
				'동적 색상 체계와 톤 기반 배경, 상태 레이어, 모션을 지원하는 Material Design 3 및 Material You 스타일의 테마',
		...
		},
		{
			...
			description:
				'rust-lang의 mdBook 디자인을 재현한 테마로, 동일한 레이아웃, UI, 그리고 5가지 내장 색상 테마를 제공합니다',
		...
		},
		{
			title: 'Exquisitus',
			description:
				'가독성과 디자인, 어느 것 하나 놓치지 않고 완벽하게 조화시킨 Starlight 테마',
		...
		},
		{
			...
			description:
				'클래식 Dracula 색상 팔레트와 라이트 변형인 Alucard를 사용한 테마',
