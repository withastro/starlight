...
{
	"link.astro": "Astro 문서",
	"link.astro.custom": "{{feature}}에 대한 Astro 문서"
}
```
...
```astro {3}
<!-- src/components/Example.astro -->
<a href="https://docs.astro.build/ko/guides/actions/">
	{Astro.locals.t('link.astro.custom', { feature: 'Astro 액션' })}
</a>
<!-- 렌더링: <a href="...">Astro 액션에 대한 Astro 문서</a> -->
```
