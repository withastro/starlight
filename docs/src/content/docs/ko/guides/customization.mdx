...
설정한 글꼴을 사이트에 적용하려면 [사용자 정의 CSS 파일](/ko/guides/css-and-tailwind/#custom-css-styles)에서 선택한 글꼴 이름을 사용하세요. 예를 들어 Starlight의 기본 글꼴을 변경하려면 사용자 정의 속성인 `--sl-font`를 설정하세요.
