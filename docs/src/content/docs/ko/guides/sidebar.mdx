...
starlight({
	sidebar: [
		{
			label: 'Constellations',
			// 'constellations' 디렉토리에 대한 링크 그룹을 자동 생성
...
starlight({
	sidebar: [
		{
			label: 'Constellations',
			// "Constellations" 그룹을 축소하지 말고 자동 생성된 하위 그룹을 축소합니다.
			collapsed: false,
