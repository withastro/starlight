...
Such attributes will be merged with the [`autogenerate.attrs` option](/guides/sidebar/#custom-html-attributes-for-autogenerated-links) of the autogenerated group this page belongs to.
