...
import { Card, CardGrid, Icon, LinkButton, Steps, Tabs, TabItem } from '@astrojs/starlight/components';
...
<LinkButton href="#_" variant="primary" icon="right-arrow" iconPlacement="start">
	Primary
</LinkButton>
<LinkButton href="#_" variant="secondary" icon="right-arrow" iconPlacement="start">
	Secondary
</LinkButton>
<LinkButton href="#_" variant="minimal" icon="right-arrow" iconPlacement="start">
	Minimal
</LinkButton>
...
<LinkButton href="#_" variant="secondary" icon="right-arrow" iconPlacement="end">
	Secondary
</LinkButton>
...
<LinkButton href="#_" variant="primary" icon="right-arrow" aria-label="Star this item" />
<LinkButton href="#_" variant="secondary" icon="right-arrow" aria-label="Star this item" />
...
<LinkButton href="#_" variant="primary" icon="right-arrow" class="custom-link-button">
	Primary
</LinkButton>
<LinkButton href="#_" variant="secondary" icon="right-arrow" class="custom-link-button">
	Secondary
</LinkButton>
<LinkButton href="#_" variant="minimal" icon="right-arrow" class="custom-link-button">
	Minimal
</LinkButton>
...
<LinkButton href="#_" variant="primary" icon="right-arrow" iconPlacement="start" dir="rtl">
	Primary
</LinkButton>

The following example is a link button in RTL where the icon is after the text.

<LinkButton href="#_" variant="primary" icon="right-arrow" iconPlacement="end" dir="rtl">
	Primary
</LinkButton>
