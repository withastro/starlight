...
<LinkButton href="#_">Primary (implicit)</LinkButton>
...
The following examples are link buttons with a custom class that changes some styles to apply some underline to the text.
