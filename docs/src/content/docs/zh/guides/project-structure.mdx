...
Starlight 项目通常遵循与其他 Astro 项目相同的文件和目录结构。有关更多详细信息，请参阅 [Astro 的项目结构文档](https://docs.astro.build/en/core-concepts/project-structure/)。
...
- `src/content/i18n/` (可选) — 支持[国际化](/guides/i18n/)的翻译数据。
