...
:::tip[Lihat Starlight beraksi]
Cobalah Starlight di browser Anda:
[buka template di StackBlitz](https://stackblitz.com/github/withastro/starlight/tree/main/examples/basics).
:::
...
Buka URL tersebut untuk mulai menjelajahi website Anda.
...
- **Konfigurasi:** Pelajari tentang opsi umum dalam [“Menyesuaikan Starlight”](/id/guides/customization/).
- **Navigasi:** Siapkan sidebar Anda dengan panduan [“Navigasi Sidebar”](/id/guides/sidebar/).
- **Komponen:** Temukan kartu, tab, dan komponen bawaan lainnya di panduan [“Komponen”](/id/components/using-components/).
- **Perluas:** Jelajahi addon komunitas di katalog [“Plugins”](/id/resources/plugins/) dan [“Themes”](/id/resources/themes/).
- **Sebarkan:** Publikasikan karya Anda dengan panduan [“Sebarkan website Anda”](https://docs.astro.build/en/guides/deploy/) di dokumentasi Astro.
...
Starlight adalah integrasi Astro. Anda dapat memperbaruinya (bersama paket Astro lain) dengan menjalankan:
...
Gunakan [konfigurasi proyek](/id/reference/configuration/) dan halaman referensi [konfigurasi _frontmatter_ halaman individual](/id/reference/frontmatter/) untuk memastikan bahwa website Starlight Anda telah dikonfigurasi dan berfungsi dengan baik.
Lihat panduan di _sidebar_ untuk bantuan menambahkan konten dan menyesuaikan website Starlight Anda.
