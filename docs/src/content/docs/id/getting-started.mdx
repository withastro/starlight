...
Tambahkan halaman baru ke situs Anda dengan membuat file Markdown di direktori `src/content/docs/`.

Baca selengkapnya tentang perutean berbasis file serta dukungan untuk MDX dan Markdoc di panduan [“Halaman”](/id/guides/pages/).

### Langkah selanjutnya

- **Konfigurasi:** Pelajari opsi umum di [“Menyesuaikan Starlight”](/id/guides/customization/).
...
- **Sebarkan:** Publikasikan karya Anda dengan panduan [“Sebarkan situs Anda”](https://docs.astro.build/en/guides/deploy/) di dokumentasi Astro.
