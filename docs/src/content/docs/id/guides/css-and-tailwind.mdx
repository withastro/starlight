...
<ThemeDesigner
	labels={{
		...
		preview: {
			...
			dimText: 'Beberapa teks, seperti daftar isi, memiliki kontras yang lebih rendah.',
...
>
	...
	<Fragment slot="tailwind-docs">
		Contoh [file konfigurasi Tailwind ](#styling-starlight-dengan-tailwind) di bawah ini
		menyertakan palet warna `accent` dan `gray` yang dihasilkan untuk digunakan di
		objek konfigurasi `theme.extend.colors`.
	</Fragment>
</ThemeDesigner>
