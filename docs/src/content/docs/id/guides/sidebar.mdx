	...
	sidebar: [
		// Sekelompok tautan yang diberi label "Constellations".
		{
			...
			items: [
				...
				// Sekelompok tautan bersarang untuk constellations seasonal.
				{
					label: 'Seasonal',
					items: [
	...
	sidebar: [
		{
			label: 'Stars',
			items: [
				// Tautan dengan badge "Supergiant".
				{
					slug: 'stars/persei',
					badge: 'Supergiant',
				},
		...
		// Grup yang dibuat secara otomatis dengan badge "Outdated".
		{
			label: 'Moons',
			badge: 'Outdated',
	...
	sidebar: [
		{
			label: 'Stars',
			items: [
				// Tautan dengan badge "Stub" berwarna kuning.
				{
					slug: 'stars/sirius',
...
Menelusuri dokumentasi dalam bahasa Portugis Brasil akan menghasilkan bilah sisi berikut:
